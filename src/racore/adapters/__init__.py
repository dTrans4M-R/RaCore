...
in-memory document source, a file-backed memory store, and an extractive LLM. Each is a
drop-in target for a real provider later (voyage/openai/pgvector/anthropic).
"""
